...
const sponsorController = {
    ...
    async createSponsor(req, res) {
        try {
            const { id_user, company_name, position, phone, website } = req.body;
    ...
    async updateSponsor(req, res) {
        try {
            ...
            sponsor.company_name = company_name || sponsor.company_name;
            sponsor.position = position || sponsor.position;
